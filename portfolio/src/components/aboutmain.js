  ...
  return (
    ...
    <div className="container">
      ...
      <h1 className="h1about">~ABOUT~</h1>
        <p className="p1about">
        I'm a Colorado native raised in the central Denver area. I was 29 when I went back to school. I graduated from the Univerisity of Colorado Denver with a B.A in Economics. During my time in college I decided that I wanted to take an alternative approach for my career and get my license to sell investment products. So I obtained me Series 6 as well as a Colorado Life License and after all was said and one I still wasn't satisfied. Within a year after graduation, I decided to take on Web Development. 
        </p>   
        <p className="p1about">
        It is indeed opportunity that has allowed me to discover  my interests and passions. The idea of exerting knowledge to serve as a resource of any sort is always a reward of its own. While I have embarked a few different journeys, I have realized that my interests and passions have led me to very different paths. Finally, for the first time I have experienced a passion to do something and I look forward to building my skills and experience with full stack web development!
        </p>
